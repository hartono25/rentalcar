...
<head>
	...
	<link rel="shortcut icon" type="image/png" href="template/img/md-warning.png">
	<style type="text/css">
		/* ::selection {
...
<body>
	...
	<div class="error">
		<div class="error__title"><?= $heading; ?></div>
		<div class="error__subtitle">Hmmm...</div>
		<div class="error__description"><?= $message; ?></div>
		<a href="http://localhost/rentalcar" class="error__button error__button--active">BACK</a>
