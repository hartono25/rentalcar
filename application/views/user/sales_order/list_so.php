            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="text-left mb-4">
                        <a href="#" data-toggle="modal" data-target="#loadSOModal" data-backdrop="static" class="btn btn-warning btn-sm">
                            Load Sales Order</a>
                        <a href="#" data-toggle="modal" data-target="#addSOModal" data-backdrop="static" class="btn btn-info btn-sm">
                            New Sales Order
                        </a>
                    </div>
                </div>
