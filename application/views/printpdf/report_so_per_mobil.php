...
<body>
            ...
            <td style="width: 60%;">
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td class="style9b">: <?= $list['nama_mobil']; ?></td>
                    </tr>
                    <tr>
                        <td class="style9b">No.Polisi</td>
                        <td class="style9b">: <?= $list['no_polisi']; ?></td>
                    </tr>
                    <tr>
                        <td class="style9b">Pemilik</td>
                        <td class="style9b">: <?= $list['nama_pemilik']; ?></td>
                    </tr>
                </table>
            </td>
            <td>
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td class="style9b">: <?= $list['no_rangka']; ?></td>
                    </tr>
                    <tr>
                        <td class="style9b">No.Mesin</td>
                        <td class="style9b">: <?= $list['no_mesin']; ?></td>
                    </tr>
                    <tr>
                        <td colspan="2">&nbsp;</td>
                    </tr>
    ...
    <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 20px;">
        ...
        <tbody>
            <?php
            $data = $this->Model->report_so_by_mobil($list['kode_mobil'], $start, $end);
            $no = 0;
            $subtotal = 0;
            foreach ($data as $d) :
